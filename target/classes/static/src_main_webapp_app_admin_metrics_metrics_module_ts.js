"use strict";
(self["webpackChunkindex_test"] = self["webpackChunkindex_test"] || []).push([["src_main_webapp_app_admin_metrics_metrics_module_ts"],{
...
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 9669);
...
/* harmony export */ });
/* harmony import */ var app_admin_metrics_metrics_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/admin/metrics/metrics.model */ 6736);
/* harmony import */ var _metrics_modal_threads_metrics_modal_threads_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../metrics-modal-threads/metrics-modal-threads.component */ 954);
...
JvmThreadsComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: JvmThreadsComponent, selectors: [["jhi-jvm-threads"]], inputs: { threads: "threads" }, decls: 60, vars: 37, consts: [["jhiTranslate", "metrics.jvm.threads.title"], ["jhiTranslate", "metrics.jvm.threads.runnable"], ["type", "success", 3, "value", "max", "striped", "animated"], ["jhiTranslate", "metrics.jvm.threads.timedwaiting"], ["type", "warning", 3, "value", "max", "striped", "animated"], ["jhiTranslate", "metrics.jvm.threads.waiting"], ["jhiTranslate", "metrics.jvm.threads.blocked"], ["data-toggle", "modal", "data-target", "#threadDump", 1, "hand", "btn", "btn-primary", "btn-sm", 3, "click"]], template: function JvmThreadsComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](40, "span", 6);
...
MetricsEndpointsRequestsComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: MetricsEndpointsRequestsComponent, selectors: [["jhi-metrics-endpoints-requests"]], inputs: { endpointsRequestsMetrics: "endpointsRequestsMetrics", updating: "updating" }, decls: 5, vars: 1, consts: [["id", "endpointsRequestsMetrics"], ["class", "table-responsive", 4, "ngIf"], [1, "table-responsive"], ["aria-describedby", "endpointsRequestsMetrics", 1, "table", "table-striped"], ["scope", "col"], ["scope", "col", 1, "text-right"], [4, "ngFor", "ngForOf"], [1, "text-right"]], template: function MetricsEndpointsRequestsComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 6912);
...
MetricsRequestComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: MetricsRequestComponent, selectors: [["jhi-metrics-request"]], inputs: { requestMetrics: "requestMetrics", updating: "updating" }, decls: 5, vars: 1, consts: [["id", "requestMetrics", "jhiTranslate", "metrics.jvm.http.title"], ["class", "table table-striped", "aria-describedby", "requestMetrics", 4, "ngIf"], ["aria-describedby", "requestMetrics", 1, "table", "table-striped"], ["scope", "col", "jhiTranslate", "metrics.jvm.http.table.code"], ["scope", "col", "jhiTranslate", "metrics.jvm.http.table.count"], ["scope", "col", "jhiTranslate", "metrics.jvm.http.table.mean", 1, "text-right"], ["scope", "col", "jhiTranslate", "metrics.jvm.http.table.max", 1, "text-right"], [4, "ngFor", "ngForOf"], ["type", "success", 3, "max", "value", "striped", "animated"], [1, "text-right"]], template: function MetricsRequestComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "h3", 0);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ 1858);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ 7005);
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ 9669);
...
/* harmony import */ var _metrics_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./metrics.service */ 5723);
/* harmony import */ var _shared_language_translate_directive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../shared/language/translate.directive */ 4243);
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ 6912);
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common */ 7005);
/* harmony import */ var _blocks_jvm_memory_jvm_memory_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./blocks/jvm-memory/jvm-memory.component */ 6126);
/* harmony import */ var _blocks_jvm_threads_jvm_threads_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blocks/jvm-threads/jvm-threads.component */ 5295);
/* harmony import */ var _blocks_metrics_system_metrics_system_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blocks/metrics-system/metrics-system.component */ 4146);
/* harmony import */ var _blocks_metrics_garbagecollector_metrics_garbagecollector_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./blocks/metrics-garbagecollector/metrics-garbagecollector.component */ 3425);
/* harmony import */ var _blocks_metrics_request_metrics_request_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blocks/metrics-request/metrics-request.component */ 9065);
/* harmony import */ var _blocks_metrics_endpoints_requests_metrics_endpoints_requests_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./blocks/metrics-endpoints-requests/metrics-endpoints-requests.component */ 6620);
/* harmony import */ var _blocks_metrics_cache_metrics_cache_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./blocks/metrics-cache/metrics-cache.component */ 6162);
/* harmony import */ var _blocks_metrics_datasource_metrics_datasource_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./blocks/metrics-datasource/metrics-datasource.component */ 9725);
...
/* harmony import */ var _metrics_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./metrics.component */ 9603);
/* harmony import */ var _metrics_route__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./metrics.route */ 5028);
/* harmony import */ var _blocks_jvm_memory_jvm_memory_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./blocks/jvm-memory/jvm-memory.component */ 6126);
/* harmony import */ var _blocks_jvm_threads_jvm_threads_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./blocks/jvm-threads/jvm-threads.component */ 5295);
/* harmony import */ var _blocks_metrics_cache_metrics_cache_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./blocks/metrics-cache/metrics-cache.component */ 6162);
/* harmony import */ var _blocks_metrics_datasource_metrics_datasource_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blocks/metrics-datasource/metrics-datasource.component */ 9725);
/* harmony import */ var _blocks_metrics_endpoints_requests_metrics_endpoints_requests_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./blocks/metrics-endpoints-requests/metrics-endpoints-requests.component */ 6620);
/* harmony import */ var _blocks_metrics_garbagecollector_metrics_garbagecollector_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./blocks/metrics-garbagecollector/metrics-garbagecollector.component */ 3425);
/* harmony import */ var _blocks_metrics_modal_threads_metrics_modal_threads_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./blocks/metrics-modal-threads/metrics-modal-threads.component */ 954);
/* harmony import */ var _blocks_metrics_request_metrics_request_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./blocks/metrics-request/metrics-request.component */ 9065);
/* harmony import */ var _blocks_metrics_system_metrics_system_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./blocks/metrics-system/metrics-system.component */ 4146);
...
/* harmony export */ });
/* harmony import */ var _metrics_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./metrics.component */ 9603);
