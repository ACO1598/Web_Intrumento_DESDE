...
class UsuarioResourceIT {
    ...
    private static final Rol DEFAULT_ROL = Rol.USER;
    private static final Rol UPDATED_ROL = Rol.ADMIN;
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nombre(UPDATED_NOMBRE).apellido(UPDATED_APELLIDO).contrasena(UPDATED_CONTRASENA);
